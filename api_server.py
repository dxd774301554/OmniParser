'''
python -m api_server --device cuda
'''
...
def parse_arguments():
    ...
    parser.add_argument('--port', type=int, default=8080, help='Port for the API')
...
async def parse(parse_request: ParseRequest):
    print('start parsing...')
    start = time.time()
    dino_labled_img, parsed_content_list = omniparser.parse(parse_request.box_threshold, parse_request.iou_threshold, parse_request.use_paddleocr, parse_request.base64_image)
